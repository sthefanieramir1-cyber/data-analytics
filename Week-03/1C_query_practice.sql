...
-- Question 1: Write a query to list the product id, product name, and
...
-- Question 2: What are the products that we carry where we have at least
...
-- Question 3: What are the products that we carry where we have at least
-- 100 units on hand? Order them in descending order by price.
...
-- Question 4: Write a query against the orders table that displays the
...
-- Question 5: Write a query against the orders table that displays the
-- total number of distinct customers who have placed orders,
...
-- Question 6: What are the products that we carry where we have less than
...
-- Question 7: Write a query to list each of the job titles in employees,
...
-- Question 8: What employees have a monthly salary that is between $2000
